...
public class World {
	...
	private int delta;
	private float deltaInSecs; // helps prevent scaling all over for things that want float delta values
	...
	public void setDelta(float deltaInSecs)
	{
	   this.deltaInSecs = deltaInSecs;
	   setDelta((int)(deltaInSecs * 1000));
	}
