...
/**
 * Constrains movement of all entities.  Currently, bullets act weird when they are shot at
 * the boundaries.  Their movement is constrained.  Better reaction would be to make them explode
 * on impact.
 * 
 * @author tescott
 *
...
public class BoundarySystem extends EntityProcessingSystem {
	...
	protected void process(Entity e) {
		// get the physics component from this entity...
