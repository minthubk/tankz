...
//         g.drawRect(offsetX * scaleX, offsetY * scaleY, scaleX * cameraSystem.getWidth(),
...
//         statusBar.draw(0, 0, statusBar.getWidth() * healthStatus, statusBar.getHeight(), 0, 0, statusBar.getWidth() *
//               healthStatus, statusBar.getHeight(), healthStatus < 0.25 ? Color.red : healthStatus < 0.6 ? Color.yellow
//               : Color.green);
//         statusBar.draw(statusBar.getWidth() * healthStatus, 0, statusBar.getWidth(), statusBar.getHeight(),
//               statusBar.getWidth() * healthStatus, 0, statusBar.getWidth(), statusBar.getHeight(), new Color(0.15f,
//                     0.15f, 0.15f));
...
//         g.setDrawMode(Graphics.MODE_ADD);
//         statusBar.draw(0, 0, statusBar.getWidth() * ammoStatus, statusBar.getHeight(), 0, 0, statusBar.getWidth() *
//               ammoStatus, statusBar.getHeight(), ammoStatus < 0.25 ? Color.red : ammoStatus < 0.6 ? Color.yellow
//               : Color.green);
//         statusBar.draw(statusBar.getWidth() * ammoStatus, 0, statusBar.getWidth(), statusBar.getHeight(),
//               statusBar.getWidth() * ammoStatus, 0, statusBar.getWidth(), statusBar.getHeight(), new Color(0.15f,
//                     0.15f, 0.15f));
//         g.setDrawMode(Graphics.MODE_NORMAL);
//         g.rotate(0, 0, 90);
//      }
